...
# Packing sample rate — set to match your WAVs to avoid unnecessary resampling.
# Override via --sample_rate in dataset.py pack_waveforms_to_hdf5.
pack_sample_rate = 16000
pack_clip_samples = pack_sample_rate * 10  # 160,000 samples
